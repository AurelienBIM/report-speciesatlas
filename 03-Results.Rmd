...
(ref:cap-rich) Specific richness of Madagascar (with all the species we studied).

```{r rich, out.width="\\textwidth", fig.cap="(ref:cap-rich)"}
knitr::include_graphics("figures/richness.pdf")
```